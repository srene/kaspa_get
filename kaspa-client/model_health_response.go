...
func NewHealthResponse(kaspadServers []KaspadResponse, database DBCheckStatus) *HealthResponse {
	this := HealthResponse{}
	this.KaspadServers = kaspadServers
...
// GetKaspadServers returns the KaspadServers field value
func (o *HealthResponse) GetKaspadServers() []KaspadResponse {
	if o == nil {
		var ret []KaspadResponse
		return ret
	}

	return o.KaspadServers
}

// GetKaspadServersOk returns a tuple with the KaspadServers field value
// and a boolean to check if the value has been set.
func (o *HealthResponse) GetKaspadServersOk() ([]KaspadResponse, bool) {
	if o == nil {
		return nil, false
	}
	return o.KaspadServers, true
}

// SetKaspadServers sets field value
...
func (o HealthResponse) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["kaspadServers"] = o.KaspadServers
