...
// checks if the EndpointsGetBlockdagBlockdagResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EndpointsGetBlockdagBlockdagResponse{}

// EndpointsGetBlockdagBlockdagResponse struct for EndpointsGetBlockdagBlockdagResponse
...
func NewEndpointsGetBlockdagBlockdagResponse() *EndpointsGetBlockdagBlockdagResponse {
	this := EndpointsGetBlockdagBlockdagResponse{}
	var networkName string = "kaspa-mainnet"
	this.NetworkName = &networkName
	var blockCount string = "260890"
	this.BlockCount = &blockCount
	var headerCount string = "2131312"
	this.HeaderCount = &headerCount
	var difficulty float32 = 3.8706776777772E12
	this.Difficulty = &difficulty
	var pastMedianTime string = "1656455670700"
	...
	var virtualDaaScore string = "19989141"
...
func (o EndpointsGetBlockdagBlockdagResponse) MarshalJSON() ([]byte, error) {
...
func (o EndpointsGetBlockdagBlockdagResponse) ToMap() (map[string]interface{}, error) {
...
type NullableEndpointsGetBlockdagBlockdagResponse struct {
	value *EndpointsGetBlockdagBlockdagResponse
	isSet bool
}

func (v NullableEndpointsGetBlockdagBlockdagResponse) Get() *EndpointsGetBlockdagBlockdagResponse {
	return v.value
}

func (v *NullableEndpointsGetBlockdagBlockdagResponse) Set(val *EndpointsGetBlockdagBlockdagResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEndpointsGetBlockdagBlockdagResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEndpointsGetBlockdagBlockdagResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEndpointsGetBlockdagBlockdagResponse(val *EndpointsGetBlockdagBlockdagResponse) *NullableEndpointsGetBlockdagBlockdagResponse {
	return &NullableEndpointsGetBlockdagBlockdagResponse{value: val, isSet: true}
}

func (v NullableEndpointsGetBlockdagBlockdagResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEndpointsGetBlockdagBlockdagResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
